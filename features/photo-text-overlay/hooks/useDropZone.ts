...
// Duplicated per feature module (see features/image-cropper/hooks/useDropZone.ts
// header precedent) rather than shared — CLAUDE.md's feature-based
// architecture keeps each feature self-contained.
