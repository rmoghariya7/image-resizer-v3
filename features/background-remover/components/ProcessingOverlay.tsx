...
export function ProcessingOverlay({ phase, progress }: Props) {
  ...
  return (
    ...
    >
      ...
      {phase === 'loading-model' && (
        <p className="mt-1 max-w-56 text-center text-xs text-gray-400">
          First-time only — the model is cached after this.
        </p>
      )}
