...
export const goalDefinitionSchema = z.object({
  ...
  // another canonical page. Defaults to true — only use this for true
  // duplicates with no unique content, never to hide a normal low-priority
  // page. Read by generateGoalMetadata to set `robots.index`.
