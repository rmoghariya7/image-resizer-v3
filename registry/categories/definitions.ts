...
export const categoryDefinitions: readonly CategoryDefinition[] = Object.freeze([
  {
    ...
    search: {
      primaryQuery:   'exam photo resizer',
      relatedQueries: [
        'upsc photo size',
        'gpsc photo size',
        'exam portal photo requirements',
        'competitive exam photo resize',
        'government exam photo dimensions',
        'upsc gpsc photo size pixels',
      ],
  ...
  },
  {
    ...
    search: {
      primaryQuery:   'id document photo resizer',
      relatedQueries: [
        'aadhaar photo size',
        'pan card photo size',
  ...
  },
  {
    ...
    search: {
      primaryQuery:   'compress image to exact file size',
      relatedQueries: [
        'reduce image size online',
        'compress image for government portal',
        'image compressor exact kb',
        'compress jpg to specific size',
  ...
  },
  {
    ...
    search: {
      primaryQuery:   'signature resize online',
      relatedQueries: [
        'digital signature size exam portal',
        'signature 140x60 pixels',
        'resize signature for upsc',
        'signature compress 20kb',
        'exam portal signature size requirements',
        'ibps signature dimensions',
      ],
      intent:       'transactional',
